...
class Criminal:
    def __init__(self, root):
        ...
        caseentry = ttk.Entry(
            upper_frame, textvariable=self.var_case_id, width=22, font=('arial', 11, 'bold'))
        caseentry.grid(row=0, column=1, padx=2, sticky=W)

        # Criminal NO
        lbl_criminal_no = Label(upper_frame, font=(
            'arial', 12, 'bold'), text="Criminal NO:", bg='white')
        lbl_criminal_no.grid(row=0, column=2, sticky=W, padx=2, pady=7)

        txt_criminal_no = ttk.Entry(
        ...
        # Criminal Name
        lbl_Name = Label(upper_frame, font=('arial', 12, 'bold'),
                         text="Criminal Name:", bg='white')
        ...
        # NickName
        lbl_nickname = Label(upper_frame, font=(
            'arial', 12, 'bold'), text="NickName:", bg='white')
        lbl_nickname.grid(row=1, column=2, sticky=W, padx=2, pady=7)

        txt_nickname = ttk.Entry(
        ...
        # Arrest Date
        lbl_arrestDate = Label(upper_frame, font=(
            'arial', 12, 'bold'), text="Arrest Date:", bg='white')
        lbl_arrestDate.grid(row=2, column=0, sticky=W, padx=2, pady=7)

        txt_arrestDate = ttk.Entry(
            upper_frame, textvariable=self.var_arrest_date, width=22, font=('arial', 11, 'bold'))
        txt_arrestDate.grid(row=2, column=1, sticky=W, padx=2, pady=7)

        # Date Of Crime
        lbl_dateofCrime = Label(upper_frame, font=(
            'arial', 12, 'bold'), text="Date Of Crime:", bg='white')
        lbl_dateofCrime.grid(row=2, column=2, sticky=W, padx=2, pady=7)

        txt_dateofCrime = ttk.Entry(
        ...
        # BirthMark
        lbl_birthMark = Label(upper_frame, font=(
            'arial', 12, 'bold'), text="BirthMark:", bg='white')
        lbl_birthMark.grid(row=4, column=2, sticky=W, padx=2, pady=7)

        txt_birthMark = ttk.Entry(
        ...
        # Crime Type
        lbl_crimeType = Label(upper_frame, font=(
            'arial', 12, 'bold'), text="Crime Type:", bg='white')
        lbl_crimeType.grid(row=0, column=4, sticky=W, padx=2, pady=7)

        txt_crimeType = ttk.Entry(
        ...
        # Father Name
        lbl_fatherName = Label(upper_frame, font=(
            'arial', 12, 'bold'), text="Father Name:", bg='white')
        lbl_fatherName.grid(row=1, column=4, sticky=W, padx=2, pady=7)

        txt_fatherName = ttk.Entry(
        ...
        # Wanted
        lbl_wanted = Label(upper_frame, font=(
            'arial', 12, 'bold'), text="Most Wanted:", bg='white')
        ...
        female = Radiobutton(radio_frame_gender, variable=self.var_gender,
                             text='Female', value='female', font=('arial', 9, 'bold'), bg='white')
        ...
        yes = Radiobutton(radio_frame_wanted, variable=self.var_wanted,
                          text='Yes', value='yes', font=('arial', 9, 'bold'), bg='white')
        ...
        search_txt = ttk.Entry(
            search_frame, textvariable=self.var_search, width=18, font=("arial", 11, "bold"))
        search_txt.grid(row=0, column=2, sticky=W, padx=5)

        # search button
        btn_search = Button(search_frame, command=self.search_data, text='Search', font=(
            "arial", 13, "bold"), width=14, bg='blue')
        ...
        crimeagency = Label(search_frame, font=(
            "arial", 30, "bold"), text="NATIONAL CRIME AGENCY", bg='white', fg='crimson')
    ...
    def add_data(self):
        if self.var_case_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost', username='root',password='password@1234', database='management')
